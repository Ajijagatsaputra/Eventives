...
import { FaSearch, FaMapMarkerAlt, FaCalendarAlt } from "react-icons/fa"; // Icons from react-icons
  ...
  return (
    <div className="bg-transparent sm:bg-transparent lg:bg-indigo-900 rounded-2xl py-6 px-4 sm:px-6 lg:px-8 shadow-xl max-w-6xl mx-auto relative z-10 lg:-mt-20 sm:mt-5 lg:py-8 mt-10 mb-5">
      <div className="grid grid-cols-1 gap-4 sm:gap-6 lg:grid-cols-3 lg:gap-8 text-white">
        {/* Search Event Input */}
        <div className="flex items-center border border-indigo-700 rounded-lg overflow-hidden transition hover:border-indigo-500 focus-within:border-indigo-500">
